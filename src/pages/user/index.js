...
export default class User extends React.Component{
    ...
    requestList = ()=>{
      // 这块请求方法也也可以直接套用axios里封装的请求方法，一句话就完事
        axios.ajax({
            url:'/table/list1',
            data:{
                params:{
            ...
            Utils.ui.confirm({
                ...
                onOk:()=>{
                    axios.ajax({
                        ...
                        if(res.code ==0){
                          // 若存在this取不到应该是在onOk中调用的方法，this指向不对，或许可以在外界使用let _this= this;
                            this.setState({
                                isVisible:false
                            })
                            this.requestList();
    ...
    handleSubmit = ()=>{
        ...
        // 这块可以复用的逻辑也可以抽象到axios的，API配置文件对象里，直接一句话就行，要是需要额外的操作还可以往里传入自定义callback
        axios.ajax({
